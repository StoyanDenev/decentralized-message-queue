...
- [CLI-REFERENCE.md](CLI-REFERENCE.md) — every `unchained` subcommand at a glance, grouped by purpose.
...
Unchained v1 is a payment + identity chain. **Not in scope**: smart contracts, EVM/WASM, gas, off-chain storage, oracles, bridges, ZK proofs, on-chain governance. See [`README.md` §15](../README.md) for the explicit non-goals list.
