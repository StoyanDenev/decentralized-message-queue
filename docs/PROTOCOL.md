...
- [`proofs/`](proofs/README.md) — formal-verification proofs (F0 + FA1–FA12 + FA-Apply + FA-Apply-2..FA-Apply-16 analytic + FrostVerifyDelegation + MakeContribCommitmentBackwardCompat, FB1–FB22 TLA+).
