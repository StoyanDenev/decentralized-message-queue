...
- `tools/` — behavioral tests of every protocol feature (162 regression suites; `docs/README.md` has a representative table).
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply-1..FA-Apply-11 analytic, plus FB1–FB16 TLA+ specs).
- `tools/` — behavioral tests of every protocol feature (162 regression suites; `docs/README.md` has a representative table).
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply-1..FA-Apply-12 analytic, plus FB1–FB17 TLA+ specs).
