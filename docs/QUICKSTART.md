...
- `tools/` — behavioral tests of every protocol feature (150 regression suites; `docs/README.md` has a representative table).
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply + FA-Apply-2, plus FB1–FB5 TLA+ specs).
