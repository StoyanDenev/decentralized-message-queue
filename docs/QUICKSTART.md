...
<<<<<<< HEAD
- `tools/` — behavioral tests of every protocol feature (165 regression suites; `docs/README.md` has a representative table).
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply-1..FA-Apply-14 analytic, plus FB1–FB19 TLA+ specs).
=======
- `tools/` — behavioral tests of every protocol feature (165 regression suites; `docs/README.md` has a representative table).
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply-1..FA-Apply-15 analytic, plus FB1–FB20 TLA+ specs).
