...
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply-1..FA-Apply-5 + FA-Apply-8 analytic, plus FB1–FB4 + FB5 + FB7 + FB8 + FB9 + FB13 TLA+ specs).