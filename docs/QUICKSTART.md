...
- `tools/` — behavioral tests of every protocol feature (169 regression suites; `docs/README.md` has a representative table).
- `docs/proofs/` — formal-verification proofs covering every safety-critical mechanism (F0 + FA1–FA12 + FA-Apply-1..FA-Apply-16 analytic, plus FB1–FB22 TLA+ specs).
