...
| v2.2 Light-client headers / state_proof RPC | ✅ shipped foundation | Merkle inclusion-proof RPC + CLI (sorted-leaves construction; SMT migration would be future for non-membership proofs); full light-client header-sync remains |
