...
| Liveness (v2.10, v2.11) | v2.10 threshold-randomness **block-beacon DE-SCOPED** (MPDH retained — `docs/proofs/V210-PhaseD-RandomnessWiring.md` §9); FROST removed from chain entirely (FROST_DEVIATION_NOTICE.md); FROST C99 is library-only; cross-shard randomness is commit-reveal. v2.11 beacon auto-detect remains | ~1 week (v2.11 only) | 0 | ~1 week |
