...
| Reference | Role |
|---|---|
| `Preliminaries.md` (F0) | Validator predicate V1–V15 (specifically V12 + V13 for cross-shard receipts) + assumption A3 (SHA-256 collision resistance) that underpins the dedup-key-choice rationale + A1 (Ed25519 EUF-CMA) backing FA7's K-of-K ratification. |
