...
- **Confidentiality / privacy** — an authentication envelope binds a message; it hides nothing and is not a confidential-transaction primitive (that is the separate §3.19/§3.20 stack; see [`ConfidentialTxBalanceSoundness.md`](ConfidentialTxBalanceSoundness.md)).
