...
> **REMOVED (2026-07-09, pre-launch register B2 — authority: Stoyan Denev, `PRE-LAUNCH-DECISIONS.md`; `FROST_DEVIATION_NOTICE.md` §8).** The frozen module and its test surfaces were deleted from the tree; git history + `C99CryptoStackAudit.md` §7/§8 + `FrostThresholdSoundness.md` are the retained design record. The bullets below record the shipped scope pre-removal.
