...
| FROST-Ed25519 | `src/crypto/frost/` | **SHIPPED** — keygen (Shamir/Lagrange over the scalar field) + threshold sign whose aggregate is a plain Ed25519 sig | Determ-original | ~210 |
