...
| Reference | Role |
|---|---|
| `Preliminaries.md` (F0) | Notation; validator predicates V12 + V13 for cross-shard receipts; assumptions A1 (Ed25519 EUF-CMA) + A3 (SHA-256 collision resistance). |
