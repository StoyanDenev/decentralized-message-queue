...
| T-OE3 (mode b) | recompute primitives | `light/verify.cpp:47-61` (`light_compute_block_digest`); `src/node/producer.cpp::make_contrib_commitment` | Byte-faithful digest recompute. |
