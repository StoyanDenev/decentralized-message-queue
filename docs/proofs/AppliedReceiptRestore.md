...
| Reference | Role |
|---|---|
| `Preliminaries.md` (F0) | V13 validator-predicate definition; assumption A1 (Ed25519 EUF-CMA) for receipt authenticity; A2 (SHA-256 CR) for leaf-key injectivity. |
