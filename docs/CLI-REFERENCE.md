...
| `bootstrap_peers` | `[]` | Initial peers to connect to (e.g. `["127.0.0.1:7771","127.0.0.1:7772"]`) |
| `m_creators` | 3 | Committee size (genesis-pinned at chain init; per-node override rejected) |
| `k_block_sigs` | 3 | Phase-2 threshold (genesis-pinned) |
