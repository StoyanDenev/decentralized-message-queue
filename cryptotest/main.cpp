...
#include <determ/crypto/sha2/sha2.h>           // SHA-256/512 + HMAC + HKDF + PBKDF2 (§3.1); determ_sha512 also feeds test-frost-c99 nonces
...
#include <determ/crypto/ed25519/ed25519_group.h> // Ed25519 scalar/group prims (FROST base)
#include <determ/crypto/frost/frost.h>         // FROST-Ed25519 (RFC 9591)
...
Subcommands:
  ...
  test-frost-c99     C99 FROST-Ed25519 keygen/DKG/PSS + threshold signing —
                     aggregate verifies as Ed25519 (C99 + OpenSSL; RFC 9591)
