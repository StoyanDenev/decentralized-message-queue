...
Phase 2 (live, skipped with --static-only):
  ...
  `determ help` order):
    ...
    test-p256-confidential-tx-c99 test-ff-pedersen-c99 test-ff-scalar-c99
    test-ff-ipa-c99
    test-ff-rangeproof-c99
...
# All 33 in-process C99-family subcommands, in `determ help` order
...
BATTERY="test-ed25519-vectors test-sha2-c99 test-chacha20-c99 test-aes-c99 \
         ...
         test-p256-oprf-c99 test-pedersen-c99 test-bp-ipa-c99 \
         test-bp-rangeproof-c99 test-bp-agg-rangeproof-c99 test-p256-balance-c99 \
         test-p256-confidential-tx-c99 test-ff-pedersen-c99 \
