...
DETERM_DSF="$(_dt_abs "$DETERM_DSF")"
DETERM_DSF_BIN="$DETERM_DSF"

export PROJECT_ROOT DETERM DETERM_WALLET DETERM_LIGHT DETERM_CRYPTOTEST DETERM_DSF DETERM_DSF_BIN
