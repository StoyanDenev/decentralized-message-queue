...
IFACE_HEADERS="include/determ/net/timer.hpp include/determ/net/event_loop.hpp include/determ/net/transport.hpp include/determ/net/loop_timer.hpp include/determ/net/iocp_event_loop.hpp include/determ/net/iocp_transport.hpp include/determ/net/sync_client.hpp include/determ/net/timer_service.hpp include/determ/net/reactor_event_loop.hpp include/determ/net/reactor_transport.hpp include/determ/net/native.hpp include/determ/net/virtual_transport.hpp"
