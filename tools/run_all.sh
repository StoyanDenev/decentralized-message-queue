...
if [ "${FAST:-0}" = "1" ]; then
    ONLY_PATTERN='test_(atomic_scope|composable_batch|dapp_register|dapp_call|s018_json_validation|merkle|committee_selection|abort_reselection|shard_routing|ed25519|ed25519_vectors|sha256|sha2_c99|chacha20_c99|aes_c99|ed25519_c99|ed25519_scalar_reduce_edge|frost_c99|x25519_c99|blake2b_c99|sha3_c99|mldsa_c99|xchacha_c99|argon2id_c99|p256_c99|p256_h2c_c99|p256_oprf_c99|pedersen_c99|bp_ipa_c99|bp_rangeproof_c99|bp_agg_rangeproof_c99|p256_balance_c99|p256_confidential_tx_c99|p256_ctx_bundle|lsag_c99|clsag_c99|ringct_spend_c99|ff_pedersen_c99|ff_scalar_c99|ff_ipa_c99|ff_rangeproof_c99|ff_agg_rangeproof_c99|ff_balance_c99|ff_confidential_tx_c99|ct_c99|rng_c99|c99_vectors|c99_api|ct_timing_selftest|anon_address|genesis_message|state_root_unit|block_rand|rate_limiter|block_digest|block_hash|binary_codec|wire_types|transaction|merge_event_codec|merge_event_bytes|consensus_msgs|tx_root|genesis|envelope|resolve_fork|shamir|random_state|snapshot_defense|encoding|chain_helpers|json_validate|block_roundtrip|config_roundtrip|tx_binary_codec|chain_append|state_types|validator_config|timing_profiles|params_constants|supply_invariant|enum_values|block_accessors|make_block_sig|domain_separation|tx_signing_bytes|make_genesis_block|pending_param_changes|merge_state|chain_apply_block|snapshot_roundtrip|state_proof_unit|abort_event_apply|equivocation_apply|equivocation_evidence|unstake_deregister_apply|cross_shard_receipt_apply|param_change_apply|pending_param_change_determinism|subsidy_distribution|subsidy_pool_clamp|merge_event_apply|cross_shard_outbound_apply|supply_lifecycle|supply_invariant_fuzz|dapp_state_transition|dapp_registry_determinism|governance_param_determinism|overflow_paths|state_root_namespaces|multi_tx_block|state_proof_namespaces|state_proof_composite_key|state_proof_value_hash|dapp_registry_trustless_read|applied_receipt_restore|applied_receipt_snapshot|stake_accounting|unstake_eligibility|fee_distribution_edge|fee_edge_cases|equivocation_multi|cross_shard_multi_receipt|multi_block_chain|tx_edge_cases|snapshot_then_apply|genesis_with_region|anon_routing|anon_address_fragmentation|merge_event_apply_edge|merge_ring_topology|block_event_composition|nef_pool_drain|tx_payload_bounds|empty_block_apply|account_create_on_credit|randomized_delay|block_timestamp|timestamp_reconciliation|node_registry|tx_replay_protection|chain_save_load|block_validator_basic|genesis_sharded|cross_shard_atomicity|cross_shard_supply_invariant|chain_ctor_bootstrap|snapshot_version_rejection|config_defaults|required_block_sigs|config_load_save|block_from_json_minimal|config_permissive|chain_shard_routing_config|view_root|frost_types|make_contrib_commitment_distinct|contrib_wire_verify|rate_limiter_bucket|merkle_proof_tampering|merkle_tree_balanced|protocol_version_pinning|binary_codec_roundtrip_exhaustive|time_monotonicity|chain_prev_hash_link|block_validator_extensive|state_root_determinism|consensus_vectors|tx_signing_determinism|merge_event_determinism|merge_state_determinism|snapshot_full_determinism|block_rand_distribution|config_determinism|hello_handshake_determinism|wire_negotiation|genesis_determinism|shard_routing_determinism|anon_address_derivation|config_knob_completeness|empty_genesis_edge|wallet_tx_batch_sign|wallet_account_import_many|wallet_keyfile_reencrypt|wallet_keyfile_argon2|operator_keyfile_kdf_audit|wallet_envelope_compat|wallet_verify_batch|wallet_batch_nonce_assign|wallet_tx_batch_summary|rpc_auth_hmac|dsf_core|light_pq_sign|pq_transaction|pq_transfer_e2e|shield|unshield|confidential_transfer)\.sh$'
